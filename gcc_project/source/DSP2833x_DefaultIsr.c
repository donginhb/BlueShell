...
{
  // Insert ISR Code here
  extern void EPWM_TZINT_HOOK(void);
  EPWM_TZINT_HOOK();
...
{
  // Insert ISR Code here
  extern void EPWM1_INT_HOOK(void);
...
{
  // Insert ISR Code here
  extern void SCIRXINTC_Callback(void);

  // 由于串口中断时间比较长，为了避免对其它事件的响应造成影响,必须先开中断
  EINT;
  SCIRXINTC_Callback();
...
{
  // Insert ISR Code here
  extern void SCIRXINTA_Callback(void);
...
{
  // Insert ISR Code here
  extern void SCIRXINTB_Callback(void);
