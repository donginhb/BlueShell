...
/* Configure eCAN for HECC mode - (reqd to access mailboxes 16 thru 31) */
	...
	ECanaShadow.CANMC.bit.SUSP = 1;		// 仿真挂起时继续运行
...
//	ECanaMboxes.MBOX1.MSGCTRL.all = 0x00000000;
	ECanaMboxes.MBOX1.MSGCTRL.all = 0x00000108;
	ECanaLAMRegs.LAM1.all = 0x800FFFFC;
//	ECanaMboxes.MBOX2.MSGCTRL.all = 0x00000000;
	ECanaMboxes.MBOX2.MSGID.all = 0xC6000003;
	ECanaLAMRegs.LAM2.all = 0x1FFFFFFF;
	ECanaMboxes.MBOX3.MSGCTRL.all = 0x00000000;
//	ECanaMboxes.MBOX4.MSGCTRL.all = 0x00000000;
	ECanaMboxes.MBOX4.MSGCTRL.all = 0x00000108;
	...
	// 注意:
	// 对于2833x, 2803x TQ=(BRPREG+1)/(SYSCLKCLK/2)
	// 对于280x, 281x   TQ=(BRPREG+1)/(SYSCLKCLK)
	// 设置波特率125kbps = 150e6/2/(39+1)/(2+1+10+1+1) = 125e3 = 125k
	ECanaShadow.CANBTC.all = 0;
	ECanaShadow.CANBTC.bit.BRPREG = 39;		// TQ=(BRPREG+1)/(SYSCLKCLK/2) = 400ns
	ECanaShadow.CANBTC.bit.TSEG2REG = 2;
	ECanaShadow.CANBTC.bit.TSEG1REG = 10;
	ECanaShadow.CANBTC.bit.SAM = 0;
	ECanaShadow.CANBTC.bit.SJWREG = 0;		// 0: synchronization jump width is 1
	...
	// Enable Mailboxe 1,2,4
	ECanaRegs.CANME.all = 0x00000016;		// Required before writing the MSGIDs
	ECanaRegs.CANMD.all = 0x00000004; 		// set mailbox 2: receive mailbox
