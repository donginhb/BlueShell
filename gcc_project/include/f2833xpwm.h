...
/*  from (-PeriodMax,PeriodMax) to (0,PeriodMax)         */  \
    (*ePWM[ch1]).CMPA.half.CMPA = _IQmpy((v.PeriodMax>>1), v.MfuncC1) + (v.PeriodMax>>1); \
    (*ePWM[ch2]).CMPA.half.CMPA = _IQmpy((v.PeriodMax>>1), v.MfuncC2) + (v.PeriodMax>>1); \
    (*ePWM[ch3]).CMPA.half.CMPA = _IQmpy((v.PeriodMax>>1), v.MfuncC3) + (v.PeriodMax>>1); \
